package com.kartal.kuaforoto.adapters;
...
public class RestaurantListAdapter extends RecyclerView.Adapter<RestaurantListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RestaurantListAdapter.MyViewHolder holder, int position) {
        ...
        holder.restaurantAddress.setText("Adres: "+restaurantModelList.get(position).getAddress());
        holder.restaurantHours.setText("Çalışma Saatleri: " + restaurantModelList.get(position).getHours().getTodaysHours());
